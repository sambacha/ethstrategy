...
import "../src/EthStrategy.sol";
contract PropertiesEthStrategyTransferable is CryticInterface,EthStrategy{
    
    constructor() 
        EthStrategy(
            86400, // 1 day execution delay
            10,    // 10% quorum
            7200,  // 2 hour vote extension
            7200,  // 2 hour initial voting delay
            86400, // 1 day initial voting period
            1e18   // Initial proposal threshold
        )
    {
